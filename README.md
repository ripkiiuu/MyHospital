...
7. Login with one of the following credentials depending on the role you want to test:
...
**Dokter** (View Perawatan & Manage self Profil)
...
**Kasir** (Manage Keuangan, View Pasien & Obat)
